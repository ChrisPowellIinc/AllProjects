...
if ($query === TRUE) {
	echo "<h3>user table created OK 2:) </h3>"; 
} else {
	echo "<h3>user table NOT created 2 :( </h3>"; 
}
////////////////////////////////////
...
$tbl_friends = "CREATE TABLE IF NOT EXISTS friends ( 
                id INT(11) NOT NULL AUTO_INCREMENT,
			  firstname1 VARCHAR(16) NOT NULL,
			  lastname1 VARCHAR(16) NOT NULL,
                user1 VARCHAR(16) NOT NULL,
			  firstname2 VARCHAR(16) NOT NULL,
