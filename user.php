...
function blockToggle(type,blockee,SearchFeild){
	...
	ajax.send("type="+type+"&blockee="+blockee);
		...
		window.addEventListener("load", function() {
			...
			var page = location.href.split("#")[1];
			var caroPages = [ "prof1.php", "page2.html", "feed3.php" ];
	...
	<body>
<div  id="crashtest1x" onClick="loadPageFromUrlIntoElement('defer.js', 'crashtest1x')"></div>
    <a href="javascript:loadPage('prof1.php', 'front')">
      <div id="UserBoxTopLeft" class="UsernameNarrow" style="display:none;"><?php echo $u; ?></div>
  </a>
