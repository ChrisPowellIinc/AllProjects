...
div.spinnable-carousel div:nth-child(1) {
    background-image: url(images/Wattz/stream.png), url(images/Wattz/live.jpg);
    background-position: center center, center center;
    background-size: 80%, cover;
    background-repeat: no-repeat;
	}
div.spinnable-carousel div:nth-child(2) {
    background-image: url(images/Wattz/honest.png), url(images/Wattz/honest.jpg);
    background-position: center center, center center;
    background-size: 80%, cover;
    background-repeat: no-repeat;	}
div.spinnable-carousel div:nth-child(3) {
    background-image: url(images/Wattz/meme.png), url(images/Wattz/meme.jpg);
    background-position: center center, center center;
    background-size: 80%, cover;
    background-repeat: no-repeat;	}
div.spinnable-carousel div:nth-child(4) {
    background-image: url(images/Wattz/pers.png), url(images/Wattz/personal.jpg);
    background-position: center center, center center;
    background-size: 80%, cover;
    background-repeat: no-repeat;	}
div.spinnable-carousel div:nth-child(5) {
    background-image: url(images/Wattz/prof.png), url(images/Wattz/proffesional.jpg);
    background-position: left center, center center;
    background-size: 80%, cover;
    background-repeat: no-repeat;}
div.spinnable-carousel div:nth-child(6) {
    background-image: url(images/Wattz/music.png), url(images/Wattz/music.jpg);
...
<link href="new/cubecss.css" rel="stylesheet" type="text/css">
