...
if(isset($_POST["u"])){
	...
	// END FORM DATA ERROR HANDLING
		...
		$subject = 'All-Of Us  Account Activation';
		$message = '<!DOCTYPE html><html><head><meta charset="UTF-8"><title>All Of Us</title></head><body style="margin:0px; font-family:Tahoma, Geneva, sans-serif;"><div style="padding:10px; background:#000; font-size:24px; color:#CCC;"><a href="http://www.all-of.us"><img src="http://www.all-of.us/images/logosmallss.jpg" width="36" height="30" alt="All Of Us" style="border:none; float:left;"></a>All Of Us Account Activation</div><div style="padding:24px; font-size:17px;">Hello '.$u.',<br /><br />Click the link below to activate your account when ready:<br /><br /><a href="http://www.all-of.us/activation.php?id='.$uid.'&u='.$u.'&e='.$e.'&p='.$p_hash.'">Click here to activate your account now</a><br /><br />Login after successful activation using your:<br />* E-mail Address: <b>'.$e.'</b></div></body></html>';
		$headers = "From: $from\n";
