...
if($numrows > 0){
	while($row = mysqli_fetch_array($query, MYSQLI_ASSOC)) {
	  ...
	  mysqli_query($con, "DELETE FROM users WHERE id='$id' AND username='$username' AND activated='0' LIMIT 1");
	  mysqli_query($con, "DELETE FROM useroptions WHERE username='$username' LIMIT 1");
    }
}
?>